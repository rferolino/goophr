...
// pProcessCh is used to process /indexs payload and start process to add the token to catalog (tCatalog).
var pProcessCh chan tPayload

// tcGet is used to retrieve a tokens catalog (documentCatalog).
